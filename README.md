...
O reconhecimento de texto com IA abre portas para uma otimização de um processo longo e cansativo como por exemplo:
Verificação de várias notas físcais e gerar um banco de dados com as informações coletadas;
Oranização de arquivos gigantestos; 
Documentos antigos que precisam ser digitalizados, catologados e armazenados devidamente em banco de dados;
